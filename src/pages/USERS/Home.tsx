      ...
      >
        <div className="container mx-auto">
          <div className="max-w-2xl text-left pl-12">
            ...
            <p className="text-black text-2xl md:text-1xl mb-10 animate-fadeDown delay-100 lg:px-2">
        ...
        >
          ...
          >
            <div className="w-full h-full flex items-center justify-end p-4 sm:p-8 md:p-24">
              <div className="w-full max-w-xs sm:max-w-sm md:max-w-md bg-opacity-80 rounded-lg p-4">
                ...
                <p className="text-sm sm:text-base md:text-lg mb-4 sm:mb-6 md:mb-14 text-black">{vehicle.material}</p>
                {/* Stats Section */}
                <div className="flex gap-4 mb-4 sm:mb-6 md:mb-9">
                  <div>
                    <p className="text-sm sm:text-base md:text-lg font-semibold text-black">{vehicle.name.name1}</p>
                    <p className="text-sm sm:text-base md:text-lg text-black hover:scale-105 transition-all duration-300">{vehicle.stats.months}</p>
                  </div>
                  <div>
                    <p className="text-sm sm:text-base md:text-lg font-semibold text-black">{vehicle.name.name2}</p>
                    <p className="text-sm sm:text-base md:text-lg text-black hover:scale-105 transition-all duration-300">{vehicle.stats.price}</p>
                  </div>
                  <div>
                    <p className="text-sm sm:text-base md:text-lg font-semibold text-black">{vehicle.name.name3}</p>
                    <p className="text-sm sm:text-base md:text-lg text-black hover:scale-105 transition-all duration-300">{vehicle.stats.area}</p>
                  </div>
                </div>

                {/* Buy Button */}
                <Link to="/create-advertisement">
                  <button className="px-4 py-2 sm:px-6 sm:py-3 text-sm sm:text-base font-semibold bg-[#F6C794] text-black/80 border rounded-[8px] hover:bg-white/10 hover:scale-105 transition-all duration-300">
                    Apply Ads Now
                  </button>
                </Link>
              </div>
    ...
    <div className="absolute bottom-20 left-24 flex items-center gap-4 z-30">
      {vehicles.map((vehicle, index) => (
        <button
          ...
          className={`flex flex-col items-center p-2 rounded-lg overflow-hidden transition-all duration-300 ${
            current % vehicles.length === index ? 'ring-[#FF9D3D] bg-orange-200' : 'opacity-70'
          }`}
        >
...
>>>>>>> 49f6fc3b83c0cef24b21ac4d324995d4c8a6984d
